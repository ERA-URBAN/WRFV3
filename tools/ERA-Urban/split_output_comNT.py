...
class enable_split_output:
  ...
  def define_dict_hourly(self):
    ...
    self.hourly = {
      41: 'P_TOP',
      42: 'T00', # not exactly useful since it is always 290 K
      43: 'P00',  # not exactly useful since it is always 100000 pa
      44: 'ZETATOP', 
      45: 'ZNU',
      46: 'ZNW',
      47: 'ZS', # only one time step necessary 
      48: 'DZS', # only one time step necessary 
      49: 'VEGFRA', 
      50: 'MU',
      51: 'MUB',
      52: 'Q2',
      ...
      56: 'U10',
      57: 'V10',
      58: 'ANTHEAT2D', # not used, since we do not use LUCY/LQF
      59: 'SEAICE',
      60: 'GRDFLX',
      61: 'ACSNOM',
      62: 'SNOW',
      ...
      66: 'TC2M_URB',
      67: 'TP2M_URB',
      68: 'UTCI_URB',  # not used,
      69: 'COSZEN',
      70: 'LAI',
      71: 'VAR',
      72: 'F',
      73: 'E',
      74: 'HGT',  # once a year or so ?
      75: 'TSK',
      76: 'SWDOWN',
      77: 'GLW',
      78: 'SWNORM',
      ...
      89: 'SNOWC',
      90: 'OLR',
      91: 'SOLDRAIN', # no data only when using WRF-HYDRO
      92: 'SFCEXC',
      93: 'Z0',
      94: 'SST',
      95: 'RAINC',
      ...
      114: 'QGRAUP',
      115: 'CLDFRA',
      116: 'TKE',     # 0.00 output when using YSU
      117: 'REFL_10CM', # no data 
      118: 'TSLB',
      119: 'SMOIS',
      120: 'SH20',
      121: 'SMCREL'
